                ...
                <div className='mt-14 w-full flex flex-col gap-6'>
                    ...
                    <div className='overflow-x-hidden'>
                        ...
                        <motion.span
                            ...
                            <span className='w-[50%] h-full bg-gradient-to-r from-blue-600 via-pink-500 to-red-500 rounded-md relative'>
            ...
            <div className='w-full lgl:w-1/2'>
                ...
                <div className='flex flex-col gap-6'>
                    ...
                    <div className='overflow-x-hidden'>
                        ...
                        <span className='w-full h-2 bgOpacity rounded-md inline-flex mt-2'>
                            <motion.span
                                initial={{ x: "-100%", opacity: 0 }} animate={{ x: 0, opacity: 1, transition: { duration: .5, delay: .5 } }} className='w-[60%] h-full bg-gradient-to-r from-blue-600 via-pink-500 to-red-500 rounded-md relative'>
